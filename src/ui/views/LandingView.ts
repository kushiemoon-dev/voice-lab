...
export class LandingView {
  ...
  constructor(onStart: () => void) {
    ...
    // Privacy block
    const privacyList = el(
      'ul',
      { class: 'landing__privacy-list' },
    ...
    this.root = el('div', { class: 'landing' }, hero, ctaSection, privacyBlock, featuresSection)
  }
