...
const allKeys: StringKey[] = [
  ...
  'landing.privacy.local',
  'landing.privacy.noRecord',
  'landing.privacy.noTrack',
  'landing.privacy.free',
  'landing.features.title',
  'landing.features.pitch',
  'landing.features.tones',
  'landing.features.phrases',
  'landing.features.record',
  'landing.features.labo',
  'header.home',
  'footer.privacy',
  'footer.disclaimer',
  'footer.openSource',
  ...
  'phrases.random',
  'phrases.counter',
  'quality.issue.highJitter',
  'quality.issue.highShimmer',
  'quality.issue.lowHNR',
  'quality.warning.borderlineJitter',
  'quality.warning.borderlineShimmer',
  'quality.warning.borderlineHNR',
  'theme.general',
  'theme.questions',
  'theme.douceur',
  'theme.quotidien',
  ...
  'intonation.context',
  'intonation.waiting',
  'volume.level.verysoft',
  'volume.level.soft',
  'volume.level.moderate',
  'volume.level.loud',
  'volume.level.veryloud',
  'labo.tab.resonance',
